...
#ifndef CPP_INSTRUMENTATION_QUICKSTART_GCP_LOGGING_H_
#define CPP_INSTRUMENTATION_QUICKSTART_GCP_LOGGING_H_
...
// Formats a structured JSON log entry in Google Cloud Logging format,
// automatically correlating with the active OpenTelemetry span and trace.
nlohmann::json FormatLogEntry(const std::string& message,
...
#endif  // CPP_INSTRUMENTATION_QUICKSTART_GCP_LOGGING_H_
